      ...
      <Container fluid="md">
        <Row>
          <Col xs={{ span: 12, order: 2 }} sm={{ span: 6, order: 1 }} className="internet-container ">
            <h1 className="text-white pt-5 display-4">The Backbone for Internet Business Worldwide</h1>
          ...
          <Col xs={{ span: 12, order: 1 }} sm={{ span: 6, order: 2 }} className="internet-container">
            <img src={globe} alt="globe" className="img-fluid p-5" />
          </Col>
        </Row>
      </Container>
    </section>
